...
namespace TiendaServicios.Api.Libro.Test
{
   public  class LibrosServiceTest
   {
        ...
        public async void GetLibros()
        {
            ...
            // para emular las accione y eventos de un ojeto en un ambiente de unit test utilizamos objetos de tipo mock

            var mockContexto = CrearContexto();

            //Emular al mapping IMapper
            var mapConfig = new MapperConfiguration(cfg => {
                cfg.AddProfile(new Mappingtest());
            });
            ...
            //Instanciar la clase manejador y pasrle como parmetros los mocks que me he creado
        ...
        public async void GuardarLibro()
        {
            ...
            request.Titulo = "Libro de Micorservice";
